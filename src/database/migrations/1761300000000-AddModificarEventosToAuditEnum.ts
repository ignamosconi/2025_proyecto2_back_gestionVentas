...
export class AddModificarEventosToAuditEnum1761300000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."registro_auditoria_tipo_evento_enum" ADD VALUE 'modificar-venta'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."registro_auditoria_tipo_evento_enum" ADD VALUE 'modificar-compra'`,
    );
  }

...
export class CreateProductoDto {
  ...
  // FK Directa a Marca
  @ApiProperty({
    description: 'ID de la Marca. Es la FK directa del Producto.',
  })
  ...
  @ApiProperty({
    description:
      'ID de la Línea existente. Se usará si no se proporciona nombreNuevaLinea.',
  })
  ...
  @ApiProperty({
    description:
      'Nombre de una nueva Línea para crear urgentemente si no se proporciona lineaId (US 10).',
  })
  @IsString()
  @IsOptional()

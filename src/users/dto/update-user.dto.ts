...
export class UpdateUserDTO {
  ...
  @ApiPropertyOptional({ example: '+54 9 11 1234-5678', description: 'Nuevo teléfono del usuario', required: false })
  @IsOptional()
  @IsString()
  phone?: string;

  @ApiPropertyOptional({ example: 'Calle Falsa 123', description: 'Nueva dirección del usuario', required: false })
  @IsOptional()
  @IsString()
  address?: string;

  @ApiPropertyOptional({ example: 'Empleado', enum: UserRole, description: 'Nuevo rol del usuario', required: false })
  @IsOptional()

...
export class UserRepository implements IUserRepository {
  ...
  async findAllDeleted(): Promise<UserEntity[]> {
    try {
      ...
      throw new InternalServerErrorException(
        'Error al obtener usuarios eliminados. ' + error,
      );
    }
  }
  ...
  async softDelete(id: number): Promise<boolean> {
    try {
      ...
      throw new InternalServerErrorException(
        'Error al eliminar (soft-delete) el usuario. ' + error,
      );
    }
  }
  ...
  async restore(id: number): Promise<boolean> {
    try {
      ...
      throw new InternalServerErrorException(
        'Error al restaurar el usuario. ' + error,
      );
    }
  }
  ...
  async findAllOwners(): Promise<UserEntity[]> {
    try {
      ...
      throw new InternalServerErrorException(
        'Error al obtener usuarios DUEÑO. ' + error,
      );
    }
  }
  ...
  async findAllEmployees(): Promise<UserEntity[]> {
    try {
      ...
      throw new InternalServerErrorException(
        'Error al obtener usuarios EMPLOYEE. ' + error,
      );
    }
  }
}

...
import { IsNotEmpty, IsInt, IsEnum, IsArray, ValidateNested } from 'class-validator';
...
export class CreateCompraDto {
  ...
  @ApiProperty({ description: 'ID del proveedor al que se realiza la compra', type: Number })
  ...
  @ApiProperty({ type: [CreateDetalleCompraDto], description: 'Lista de productos comprados' })
  @IsNotEmpty({ message: 'La compra debe tener al menos un detalle (producto).' })

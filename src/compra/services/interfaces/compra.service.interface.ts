...
export interface CompraServiceInterface {
  create(createCompraDto: CreateCompraDto, userId: number): Promise<CompraResponseDto>;
  ...
  update(idCompra: number, updateCompraDto: UpdateCompraDto): Promise<CompraResponseDto>;
}
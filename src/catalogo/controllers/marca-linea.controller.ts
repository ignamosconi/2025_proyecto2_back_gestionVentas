...
export class MarcaLineaController implements MarcaLineaControllerInterface {
  ...
  @Get()
  @ApiOperation({
    summary: 'Obtiene todas las líneas asignadas a una Marca específica.',
  })
  @ApiParam({
    name: 'marcaId',
    description: 'ID de la Marca cuyas asignaciones se desean listar.',
  })
  @ApiResponse({
    status: 200,
    description: 'Listado de vínculos Marca-Línea.',
    type: [MarcaLinea],
  })
  ...
  async findAllByMarca(
    ...
    console.log(
      `[MarcaLineaController] GET /marca/${marcaId}/linea - Listando líneas asignadas a marca.`,
    );
  ...
  @ApiOperation({
    summary: 'Listado general de todos los vínculos Marca-Línea activos.',
  })
  @ApiResponse({
    status: 200,
  ...
  @Roles(UserRole.OWNER)
  @ApiOperation({
    summary: 'Listado de vínculos Marca-Línea eliminados (soft-deleted).',
  })
  @ApiResponse({
    status: 200,
    description: 'Vínculos eliminados.',
    type: [MarcaLinea],
  })
  ...
  @ApiParam({
    name: 'lineaId',
    description: 'ID de la Línea a asignar.',
    type: Number,
  })
  @ApiResponse({
    status: 201,
    description: 'Vínculo creado exitosamente.',
    type: MarcaLinea,
  })
  @ApiResponse({
    status: 409,
    description: 'El vínculo ya existe (Violación de PK).',
  })
  async assignLinea(
    @Param('marcaId', ParseIntPipe) marcaId: number,
    ...
    console.log(
      `[MarcaLineaController] POST /marca/${marcaId}/linea/${lineaId} - Asignando línea a marca.`,
    );
  ...
  async unassignLinea(
    ...
    console.log(
      `[MarcaLineaController] DELETE /marca/${marcaId}/linea/${lineaId} - Desasignando línea de marca.`,
    );

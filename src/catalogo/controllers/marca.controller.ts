...
export class MarcaController implements MarcaControllerInterface {
  ...
  findAll(): Promise<Marca[]> {
    console.log(
      `[MarcaController] GET /marcas - Obteniendo todas las marcas activas.`,
    );
  ...
  findAllDeleted(): Promise<Marca[]> {
    console.log(
      `[MarcaController] GET /marcas/eliminadas - Obteniendo marcas eliminadas.`,
    );
  ...
  findOne(@Param('id', ParseIntPipe) id: string): Promise<Marca> {
    console.log(
      `[MarcaController] GET /marcas/${id} - Obteniendo marca activa por ID.`,
    );
  ...
  create(@Body() createMarcaDto: CreateMarcaDto): Promise<Marca> {
    console.log(
      `[MarcaController] POST /marcas - Creando marca con datos:`,
      createMarcaDto,
    );
  ...
  update(
    ...
    console.log(
      `[MarcaController] PUT /marcas/${id} - Actualizando marca con datos:`,
      updateMarcaDto,
    );
  ...
  softDelete(@Param('id', ParseIntPipe) id: string): Promise<void> {
    console.log(
      `[MarcaController] DELETE /marcas/${id} - Eliminando marca lógicamente.`,
    );
  ...
  restore(@Param('id', ParseIntPipe) id: string): Promise<void> {
    console.log(
      `[MarcaController] PATCH /marcas/${id}/restore - Restaurando marca eliminada.`,
    );

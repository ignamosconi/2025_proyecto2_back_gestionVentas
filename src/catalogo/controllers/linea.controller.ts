...
export class LineaController implements LineaControllerInterface {
  ...
  findAll(): Promise<Linea[]> {
    console.log(
      `[LineaController] GET /lineas - Obteniendo todas las líneas activas.`,
    );
  ...
  findAllSoftDeleted(): Promise<Linea[]> {
    console.log(
      `[LineaController] GET /lineas/deleted - Obteniendo todas las líneas eliminadas.`,
    );
  ...
  findOne(@Param('id', ParseIntPipe) id: number): Promise<Linea> {
    console.log(
      `[LineaController] GET /lineas/${id} - Obteniendo línea activa por ID.`,
    );
  ...
  async create(@Body() data: CreateLineaDto): Promise<Linea> {
    console.log(
      `[LineaController] POST /lineas - Creando nueva línea con datos:`,
      data,
    );
  ...
  async update(
    ...
    console.log(
      `[LineaController] PUT /lineas/${id} - Actualizando línea con datos:`,
      data,
    );
  ...
  async softDelete(@Param('id', ParseIntPipe) id: number): Promise<void> {
    console.log(
      `[LineaController] DELETE /lineas/${id} - Eliminando línea lógicamente.`,
    );
  ...
  async restore(@Param('id', ParseIntPipe) id: number): Promise<void> {
    console.log(
      `[LineaController] PATCH /lineas/restore/${id} - Restaurando línea eliminada.`,
    );
